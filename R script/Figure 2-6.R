...
setwd('C:/Users/xiapu/OneDrive/desktop/WPP/1-Manuscript/Figure')
ggsave("Figure 1A.pdf",p,width = 12, height = 12)


############################  Figure 1B  ############################ 
# load dataSet
setwd('C:/Users/xiapu/OneDrive/desktop/AOP network files')
data.nano <- read.csv('data_nano.csv')[,-1]
...
setwd('C:/Users/xiapu/OneDrive/desktop/WPP/1-Manuscript/Figure')
ggsave("Figure 1B.pdf",p,width = 15, height = 12)


############################  Figure 2  ############################ 
setwd('C:/Users/xiapu/OneDrive/desktop/WPP/qAOP/')
...
pdf(file="C:/Users/xiapu/OneDrive/桌面/WPP/1-Manuscript/Figure/Figure 2.pdf",
    width = 10, height = 10)
draw(Heatmap(hdata,
...
pdf(file="C:/Users/xiapu/OneDrive/desktop/WPP/1-Manuscript/Figure/Figure 3.pdf",
    width = 10, height = 10)
draw(Heatmap(hdata,
             bottom_annotation = ha_col_bot,
             top_annotation = ha_col_top,
...
plotIndiv(MyResult.splsda, ind.names = T, legend= T,
          ellipse = T, star = T, title = 'sPLS-DA',
...
### Figure 5C
setwd('C:/Users/xiapu/OneDrive/desktop/WPP/tAOP')
tAOP <- list.files(getwd()) %>% .[grep('MIE',.)] %>%
  matrix(.)  %>%
  apply(.,1,function(x) read.csv(x))  %>%
  sapply(.,function(x) {
    y <- as.matrix(x)
    y[y[,4]=='mie',2]
  }) %>%
